...
public class JChatBox implements Runnable {
   ...
   public final static String END_CHAT_SESSION =
      Character.valueOf((char)0).toString(); // Indicates the end of a session
   ...
   public static JFrame mainChatFrame = null;
   ...
   private static void initGUI() {
      ...
      mainChatFrame = new JFrame("Chat Room");
      mainChatFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
      mainChatFrame.setContentPane(mainPane);
      //Image img = new ImageIcon();
      mainChatFrame.setIconImage(new ImageIcon("Jface.png").getImage());
      mainChatFrame.setResizable(false);
      mainChatFrame.setSize(mainChatFrame.getPreferredSize());
      mainChatFrame.setLocation(200, 200);
      mainChatFrame.pack();
